if (game:GetService("CoreGui")):FindFirstChild("SapphireV5") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).SapphireV5:Destroy();
...
ImageButton.Image = "rbxassetid://103313795004373";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("SapphireV5")).Enabled = not (game.CoreGui:FindFirstChild("SapphireV5")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://103313795004373";
	Title.Parent = Frame;
...
function Update:StartLoad()
	...
	LoadingBar.BackgroundColor3 = Color3.fromRGB(204, 0, 255);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SapphireV5") then
			makefolder("SapphireV5");
		end;
		if not isfolder("SapphireV5/Library/") then
			makefolder("SapphireV5/Library/");
		end;
		if not isfile(("SapphireV5/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SapphireV5/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SapphireV5/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("SapphireV5/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("SapphireV5/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local SapphireV5 = Instance.new("ScreenGui");
	SapphireV5.Name = "SapphireV5";
	SapphireV5.Parent = game.CoreGui;
	SapphireV5.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = SapphireV5;
	...
	CreateButton("Reset Config", function()
		if isfolder("SapphireV5") then
			delfolder("SapphireV5");
		end;
