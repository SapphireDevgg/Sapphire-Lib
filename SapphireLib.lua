...
function SapphireLib:CreateInterface(name, subinfo, linkpromo, alignment, theme)
	
	-- start init setup
	--print('simple SapphireLib: alignment -> ' .. tostring(alignment))
...
-- Toggle Button to open/close SapphireLib
local Players = game:GetService("Players")
local playerGui = Players.LocalPlayer:WaitForChild("PlayerGui")

local toggleButton = Instance.new("TextButton")
toggleButton.Name = "ToggleSapphireLib"
toggleButton.Text = "Toggle UI"
toggleButton.Size = UDim2.new(0, 120, 0, 30)
toggleButton.Position = UDim2.new(0, 10, 0.5, -15)
toggleButton.BackgroundColor3 = Color3.fromRGB(103, 49, 171)
...
toggleButton.MouseButton1Click:Connect(function()
    local core = playerGui:FindFirstChild("corehandler")
    if core then
